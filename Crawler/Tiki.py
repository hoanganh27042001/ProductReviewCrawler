...
class Tiki:
    def __init__(self, url: str):
        self.url = url
    def search_product_by_keyword(self, keyword: str, limit: int = 10):
        print("Searching for {} in Tiki ...".format(keyword))
        url = 'https://tiki.vn/api/v2/products?limit={}&include=advertisement&aggregations=2&trackity_id=dbda744c-724c-2c2b-b5e7-1842471a03d6&q={}'.format(limit, keyword)
    ...
    def find_reviews_by_keyword(self, keyword: str, search_limit : int = 10, review_limit: int = 50):
        ...
        for product in product_lists:
            ...
            collections.append({'item_id': str(itemid), 'name': name, 'shop_id': str(shopid), 'reviews': review, 'source': 'tiki'})
        return collections
